...
export default function Offers() {
  return (
    <div className="w-[90%] sm:w-[85%] lg:w-[82%] -mt-[100px] md:mt-6 lg:mt-[60px]  h-auto sm:h-[60vh] bg-gradient-to-b from-[#fde1ff] via-[#e1ffea22] to-transparent mx-auto rounded-lg p-6 sm:p-10">
